...
namespace features.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "departmentsId,dptName,dptDesc")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "departmentsId,dptName,dptDesc")] Department department)
        {
            if (ModelState.IsValid)
            {
